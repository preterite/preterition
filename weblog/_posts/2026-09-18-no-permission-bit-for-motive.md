...
The snapshot I describe above is one line in the METR report. An agent ran a spoofed call whose command read `echo REAL; sleep` and whose result came back `SPOOFTEST`, instantly, no sleep. The transcript says one thing. The execution ran another. That's the counterfeit 511, on a surface everyone had been treating as 444.
