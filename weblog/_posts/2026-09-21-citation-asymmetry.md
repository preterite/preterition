...
---
I sometimes find myself slightly annoyed by rhetoric and composition's canonizing of James Berlin's dismissal of cognitive psychology's contributions to the field. I wonder whether Berlin might be embarrassed today to see how widely he missed, and how much the foundational principles he hand-waved away underpin contemporary understandings of language use and meaning-making. I've previously [discussed](https://doi.org/10.1080/07350198.2014.917514) such hasty moves in other areas. And it made me scope myself a bit: what are all the things *I've* missed? Where in the areas I've investigated have I missed canonical scholarship?

So I used [Claude](https://claude.ai) to help me build a tool.

The tool measures the distance between what a field claims and what it reads. I've called it the citation asymmetry detector, pre-release version 0.2. The tool takes an area or concept that a field engages and measures two phenomena separately: how much the field's own journals cite the outside scholarship on that concept, and how much everyone outside the field does. The tool uses ISSNs to draw disciplinary boundaries with a list of named journals. On the disciplinary side, the tool searches [*The Bedford Bibliography for Teachers of Writing*](https://search.worldcat.org/title/760902194) twice, via two separate routes: first it queries whether the field's canonical map has a place for the concept in question by traversing a crosswalk from [the *Bedford Bibliography*'s subcategories](https://doi.org/10.1080/07350198.2018.1424480) to the defined concept. Next, it uses a vector database of the *Bedford Bibliography* [indexed by meaning rather than keyword](https://github.com/tobi/qmd) to perform a semantic search and return results for text engaging that concept under other names. For a different field, substitute a different indexed bibliography. When the two routes disagree, the tool reports the disagreement, which often suggests the field engaged the concept but filed it differently---in other words, it reports how the field masked the concept. That masking is the tool's real target: it seeks what composition and rhetoric calls its concepts, then seeks those concepts under other names across other disciplines.

<!--more-->

Two cautions: first, the tool uses API keys to query databases notorious for undercounting humanities publications---that's a structural problem I can't fix. Second, because it runs on ISSNs, it catches only the nine indexed journals---*College Composition and Communication*, *College English*, *Rhetoric Review*, *Rhetoric Society Quarterly*, *JAC*, *Research in the Teaching of English*, *Teaching English in the Two-Year College*, *Computers and Composition*, and *Written Communication*. The tool doesn't catch unindexed journals. That's where a substantial portion of our field's scholarly work lives, and a fix I need to figure out if I can make before I consider releasing citation asymmetry detector version 1.0: right now, the tool has a sizable blind spot. But as a first-pass survey of what our core journals cite *and don't cite*, the tool works to give me an initial idea of my own disciplinary blind spots.
...
For scale, David Bartholomae's *Inventing the University* has 697 indexed citations.
