...
Reads the committed calendar at _calendar/preterite-upcoming.ics, expands
...
ICS = REPO / "_calendar" / "preterite-upcoming.ics"
...
def main():
    ...
    payload = {
        "_comment": ("GENERATED by _scripts/expand_calendar.py from "
                     "_calendar/preterite-upcoming.ics. Do not edit by "
